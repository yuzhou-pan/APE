...
for (w in range.weeks){
  ...
  for (i in c(1:10)){
    ...
    setdiff(df.7days, df.test) -> df.train
...
write.csv(result.full, paste0("result.full.", n, ".nobuffer.0212.csv"), row.names = F)

write.csv(summary.fixed.1.1, paste0("./summary/summary.fixed.1.1_", n, ".nobuffer.csv"), row.names = T)
write.csv(summary.fixed.1.2, paste0("./summary/summary.fixed.1.2_", n, ".nobuffer.csv"), row.names = T)
write.csv(summary.fixed.2.1, paste0("./summary/summary.fixed.2.1_", n, ".nobuffer.csv"), row.names = T)
write.csv(summary.fixed.2.2, paste0("./summary/summary.fixed.2.2_", n, ".nobuffer.csv"), row.names = T)
write.csv(summary.fixed.3.1, paste0("./summary/summary.fixed.3.1_", n, ".nobuffer.csv"), row.names = T)
write.csv(summary.fixed.3.2, paste0("./summary/summary.fixed.3.2_", n, ".nobuffer.csv"), row.names = T)
write.csv(summary.fixed.4.1, paste0("./summary/summary.fixed.4.1_", n, ".nobuffer.csv"), row.names = T)
write.csv(summary.fixed.4.2, paste0("./summary/summary.fixed.4.2_", n, ".nobuffer.csv"), row.names = T)

write.csv(summary.hyperpar.1.1, paste0("./summary/summary.hyperpar.1.1_", n, ".nobuffer.csv"), row.names = T)
write.csv(summary.hyperpar.1.2, paste0("./summary/summary.hyperpar.1.2_", n, ".nobuffer.csv"), row.names = T)
write.csv(summary.hyperpar.2.1, paste0("./summary/summary.hyperpar.2.1_", n, ".nobuffer.csv"), row.names = T)
write.csv(summary.hyperpar.2.2, paste0("./summary/summary.hyperpar.2.2_", n, ".nobuffer.csv"), row.names = T)
write.csv(summary.hyperpar.3.1, paste0("./summary/summary.hyperpar.3.1_", n, ".nobuffer.csv"), row.names = T)
write.csv(summary.hyperpar.3.2, paste0("./summary/summary.hyperpar.3.2_", n, ".nobuffer.csv"), row.names = T)
write.csv(summary.hyperpar.4.1, paste0("./summary/summary.hyperpar.4.1_", n, ".nobuffer.csv"), row.names = T)
write.csv(summary.hyperpar.4.2, paste0("./summary/summary.hyperpar.4.2_", n, ".nobuffer.csv"), row.names = T)
